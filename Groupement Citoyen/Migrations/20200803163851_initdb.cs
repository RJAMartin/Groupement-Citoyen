        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MontantPortefeuille = table.Column<float>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DateAchat = table.Column<DateTime>(nullable: false, defaultValueSql: "GetDate()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProducteurId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Produits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Produits_AspNetUsers_ProducteurId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetailsCommandes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetailsCommandes_Commandes_CommandeId",
                        column: x => x.CommandeId,
                        principalTable: "Commandes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DetailsCommandes_Produits_ProduitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetailsCommandes_CommandeId",
                table: "DetailsCommandes",
                column: "CommandeId");

            migrationBuilder.CreateIndex(
                name: "IX_DetailsCommandes_ProduitId",
                table: "DetailsCommandes",
                column: "ProduitId");
